...
type PutCharactersCharacterIDMailMailIDForbidden struct {
	Payload PutCharactersCharacterIDMailMailIDForbiddenBody
}
...
type PutCharactersCharacterIDMailMailIDInternalServerError struct {
	Payload PutCharactersCharacterIDMailMailIDInternalServerErrorBody
}
...
func (o *PutCharactersCharacterIDMailMailIDForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PutCharactersCharacterIDMailMailIDForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("putCharactersCharacterIdMailMailIdForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *PutCharactersCharacterIDMailMailIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PutCharactersCharacterIDMailMailIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("putCharactersCharacterIdMailMailIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
