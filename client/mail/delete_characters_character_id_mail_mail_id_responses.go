...
type DeleteCharactersCharacterIDMailMailIDForbidden struct {
	Payload DeleteCharactersCharacterIDMailMailIDForbiddenBody
}
...
type DeleteCharactersCharacterIDMailMailIDInternalServerError struct {
	Payload DeleteCharactersCharacterIDMailMailIDInternalServerErrorBody
}
...
func (o *DeleteCharactersCharacterIDMailMailIDForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteCharactersCharacterIDMailMailIDForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("deleteCharactersCharacterIdMailMailIdForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *DeleteCharactersCharacterIDMailMailIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteCharactersCharacterIDMailMailIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("deleteCharactersCharacterIdMailMailIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
