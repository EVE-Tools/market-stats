...
type DeleteCharactersCharacterIDMailLabelsLabelIDForbidden struct {
	Payload DeleteCharactersCharacterIDMailLabelsLabelIDForbiddenBody
}
...
type DeleteCharactersCharacterIDMailLabelsLabelIDInternalServerError struct {
	Payload DeleteCharactersCharacterIDMailLabelsLabelIDInternalServerErrorBody
}
...
func (o *DeleteCharactersCharacterIDMailLabelsLabelIDForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteCharactersCharacterIDMailLabelsLabelIDForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("deleteCharactersCharacterIdMailLabelsLabelIdForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *DeleteCharactersCharacterIDMailLabelsLabelIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteCharactersCharacterIDMailLabelsLabelIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("deleteCharactersCharacterIdMailLabelsLabelIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
