...
type GetCharactersCharacterIDShipForbidden struct {
	Payload GetCharactersCharacterIDShipForbiddenBody
}
...
type GetCharactersCharacterIDShipInternalServerError struct {
	Payload GetCharactersCharacterIDShipInternalServerErrorBody
}
...
func (o *GetCharactersCharacterIDShipForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersCharacterIDShipForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersCharacterIdShipForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *GetCharactersCharacterIDShipInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersCharacterIDShipInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersCharacterIdShipInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
