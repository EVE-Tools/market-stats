...
type GetCorporationsCorporationIDIconsInternalServerError struct {
	Payload GetCorporationsCorporationIDIconsInternalServerErrorBody
}
...
func (o *GetCorporationsCorporationIDIconsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCorporationsCorporationIDIconsInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCorporationsCorporationIdIconsInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
