...
type GetCorporationsNamesInternalServerError struct {
	Payload GetCorporationsNamesInternalServerErrorBody
}
...
func (o *GetCorporationsNamesInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCorporationsNamesInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCorporationsNamesInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
