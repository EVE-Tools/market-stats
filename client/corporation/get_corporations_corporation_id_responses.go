...
type GetCorporationsCorporationIDInternalServerError struct {
	Payload GetCorporationsCorporationIDInternalServerErrorBody
}
...
func (o *GetCorporationsCorporationIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCorporationsCorporationIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCorporationsCorporationIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
