...
type PostFleetsFleetIDWingsWingIDSquadsForbidden struct {
	Payload PostFleetsFleetIDWingsWingIDSquadsForbiddenBody
}
...
type PostFleetsFleetIDWingsWingIDSquadsInternalServerError struct {
	Payload PostFleetsFleetIDWingsWingIDSquadsInternalServerErrorBody
}
...
func (o *PostFleetsFleetIDWingsWingIDSquadsForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostFleetsFleetIDWingsWingIDSquadsForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("postFleetsFleetIdWingsWingIdSquadsForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *PostFleetsFleetIDWingsWingIDSquadsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostFleetsFleetIDWingsWingIDSquadsInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("postFleetsFleetIdWingsWingIdSquadsInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
