...
type GetAlliancesAllianceIDCorporationsInternalServerError struct {
	Payload GetAlliancesAllianceIDCorporationsInternalServerErrorBody
}
...
func (o *GetAlliancesAllianceIDCorporationsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetAlliancesAllianceIDCorporationsInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getAlliancesAllianceIdCorporationsInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
