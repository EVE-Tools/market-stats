...
type GetAlliancesInternalServerError struct {
	Payload GetAlliancesInternalServerErrorBody
}
...
func (o *GetAlliancesInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetAlliancesInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getAlliancesInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
