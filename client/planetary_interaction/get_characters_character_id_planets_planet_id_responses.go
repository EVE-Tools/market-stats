...
type GetCharactersCharacterIDPlanetsPlanetIDForbidden struct {
	Payload GetCharactersCharacterIDPlanetsPlanetIDForbiddenBody
}
...
type GetCharactersCharacterIDPlanetsPlanetIDInternalServerError struct {
	Payload GetCharactersCharacterIDPlanetsPlanetIDInternalServerErrorBody
}
...
func (o *GetCharactersCharacterIDPlanetsPlanetIDForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersCharacterIDPlanetsPlanetIDForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersCharacterIdPlanetsPlanetIdForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *GetCharactersCharacterIDPlanetsPlanetIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersCharacterIDPlanetsPlanetIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersCharacterIdPlanetsPlanetIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
