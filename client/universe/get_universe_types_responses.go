...
type GetUniverseTypesInternalServerError struct {
	Payload GetUniverseTypesInternalServerErrorBody
}
...
func (o *GetUniverseTypesInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniverseTypesInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniverseTypesInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
