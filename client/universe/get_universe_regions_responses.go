...
type GetUniverseRegionsInternalServerError struct {
	Payload GetUniverseRegionsInternalServerErrorBody
}
...
func (o *GetUniverseRegionsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniverseRegionsInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniverseRegionsInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
