...
type GetUniverseStationsStationIDInternalServerError struct {
	Payload GetUniverseStationsStationIDInternalServerErrorBody
}
...
func (o *GetUniverseStationsStationIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniverseStationsStationIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniverseStationsStationIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
