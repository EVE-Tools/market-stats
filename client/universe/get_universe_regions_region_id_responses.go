...
type GetUniverseRegionsRegionIDInternalServerError struct {
	Payload GetUniverseRegionsRegionIDInternalServerErrorBody
}
...
func (o *GetUniverseRegionsRegionIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniverseRegionsRegionIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniverseRegionsRegionIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
