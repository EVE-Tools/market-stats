...
type GetUniverseConstellationsInternalServerError struct {
	Payload GetUniverseConstellationsInternalServerErrorBody
}
...
func (o *GetUniverseConstellationsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniverseConstellationsInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniverseConstellationsInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
