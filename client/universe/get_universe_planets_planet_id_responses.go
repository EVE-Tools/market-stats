...
type GetUniversePlanetsPlanetIDInternalServerError struct {
	Payload GetUniversePlanetsPlanetIDInternalServerErrorBody
}
...
func (o *GetUniversePlanetsPlanetIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniversePlanetsPlanetIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniversePlanetsPlanetIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
