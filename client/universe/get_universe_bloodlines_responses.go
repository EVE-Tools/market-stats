...
func (o *GetUniverseBloodlinesInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniverseBloodlinesInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniverseBloodlinesInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
