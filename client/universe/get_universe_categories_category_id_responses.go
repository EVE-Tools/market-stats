...
type GetUniverseCategoriesCategoryIDInternalServerError struct {
	Payload GetUniverseCategoriesCategoryIDInternalServerErrorBody
}
...
func (o *GetUniverseCategoriesCategoryIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetUniverseCategoriesCategoryIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getUniverseCategoriesCategoryIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
