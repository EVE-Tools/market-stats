...
type GetLoyaltyStoresCorporationIDOffersInternalServerError struct {
	Payload GetLoyaltyStoresCorporationIDOffersInternalServerErrorBody
}
...
func (o *GetLoyaltyStoresCorporationIDOffersInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetLoyaltyStoresCorporationIDOffersInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getLoyaltyStoresCorporationIdOffersInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
