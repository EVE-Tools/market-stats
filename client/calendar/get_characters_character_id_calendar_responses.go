...
func (o *GetCharactersCharacterIDCalendarForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersCharacterIDCalendarForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersCharacterIdCalendarForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *GetCharactersCharacterIDCalendarInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersCharacterIDCalendarInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersCharacterIdCalendarInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
