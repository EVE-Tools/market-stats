...
type PutCharactersCharacterIDCalendarEventIDForbidden struct {
	Payload PutCharactersCharacterIDCalendarEventIDForbiddenBody
}
...
type PutCharactersCharacterIDCalendarEventIDInternalServerError struct {
	Payload PutCharactersCharacterIDCalendarEventIDInternalServerErrorBody
}
...
func (o *PutCharactersCharacterIDCalendarEventIDForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PutCharactersCharacterIDCalendarEventIDForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("putCharactersCharacterIdCalendarEventIdForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *PutCharactersCharacterIDCalendarEventIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PutCharactersCharacterIDCalendarEventIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("putCharactersCharacterIdCalendarEventIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
