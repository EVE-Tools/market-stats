...
type GetOpportunitiesTasksInternalServerError struct {
	Payload GetOpportunitiesTasksInternalServerErrorBody
}
...
func (o *GetOpportunitiesTasksInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetOpportunitiesTasksInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getOpportunitiesTasksInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
