...
type GetOpportunitiesGroupsGroupIDInternalServerError struct {
	Payload GetOpportunitiesGroupsGroupIDInternalServerErrorBody
}
...
func (o *GetOpportunitiesGroupsGroupIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetOpportunitiesGroupsGroupIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getOpportunitiesGroupsGroupIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
