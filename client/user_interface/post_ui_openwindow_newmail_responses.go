...
func (o *PostUIOpenwindowNewmailForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostUIOpenwindowNewmailForbiddenBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("postUiOpenwindowNewmailForbidden"+"."+"error", "body", o.Error); err != nil {
		return err
	}
...
func (o *PostUIOpenwindowNewmailInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostUIOpenwindowNewmailInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("postUiOpenwindowNewmailInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
