...
type GetWarsWarIDKillmailsInternalServerError struct {
	Payload GetWarsWarIDKillmailsInternalServerErrorBody
}
...
func (o *GetWarsWarIDKillmailsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetWarsWarIDKillmailsInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getWarsWarIdKillmailsInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
