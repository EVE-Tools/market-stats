...
type GetCharactersCharacterIDInternalServerError struct {
	Payload GetCharactersCharacterIDInternalServerErrorBody
}
...
func (o *GetCharactersCharacterIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersCharacterIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersCharacterIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
