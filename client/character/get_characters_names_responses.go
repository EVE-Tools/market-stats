...
func (o *GetCharactersNamesInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetCharactersNamesInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getCharactersNamesInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
