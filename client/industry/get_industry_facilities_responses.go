...
type GetIndustryFacilitiesInternalServerError struct {
	Payload GetIndustryFacilitiesInternalServerErrorBody
}
...
func (o *GetIndustryFacilitiesInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetIndustryFacilitiesInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getIndustryFacilitiesInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
