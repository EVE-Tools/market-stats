...
type GetIndustrySystemsInternalServerError struct {
	Payload GetIndustrySystemsInternalServerErrorBody
}
...
func (o *GetIndustrySystemsInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetIndustrySystemsInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getIndustrySystemsInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
