...
type GetDogmaAttributesAttributeIDInternalServerError struct {
	Payload GetDogmaAttributesAttributeIDInternalServerErrorBody
}
...
func (o *GetDogmaAttributesAttributeIDInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetDogmaAttributesAttributeIDInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getDogmaAttributesAttributeIdInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
