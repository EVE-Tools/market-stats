...
type GetMarketsRegionIDOrdersInternalServerError struct {
	Payload GetMarketsRegionIDOrdersInternalServerErrorBody
}
...
func (o *GetMarketsRegionIDOrdersInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetMarketsRegionIDOrdersInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getMarketsRegionIdOrdersInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
