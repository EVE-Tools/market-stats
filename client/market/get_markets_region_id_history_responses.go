...
type GetMarketsRegionIDHistoryInternalServerError struct {
	Payload GetMarketsRegionIDHistoryInternalServerErrorBody
}
...
func (o *GetMarketsRegionIDHistoryInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetMarketsRegionIDHistoryInternalServerErrorBody) validateError(formats strfmt.Registry) error {

	if err := validate.Required("getMarketsRegionIdHistoryInternalServerError"+"."+"error", "body", o.Error); err != nil {
		return err
	}
